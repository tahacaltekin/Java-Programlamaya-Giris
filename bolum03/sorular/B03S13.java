...
/*
 * (Finans uygulamasý: vergi hesaplama) Madde 3.5, ComputeTax.java, tek yükümlü için vergiyi
 * hesaplayan kaynak kodu verir. Madde 3.5’i her vergilendirme türü için tamamlayýnýz.
 */
		    ...
		    if (status == 0) { 
		      if (income <= 8350)
		    	...
		    	if (income <= 16700)
			        ...
			        tax = 16700 * 0.10 + (67900 - 16700) * 0.15 +
			          (137050 - 16700) * 0.25 + (208850 - 137050) * 0.28 +
			          (income - 208850) * 0.33;
			      else
			        tax = 16700 * 0.10 + (67900 - 16700) * 0.15 +
